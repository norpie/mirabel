...
{#if lines || sampleTerminalOutput}
    <div
        id="terminal"
        class="flex h-full max-h-full w-full max-w-full overflow-hidden rounded-lg bg-card"
    ></div>
{:else}
    <div class="flex h-full w-full items-center justify-center rounded bg-card">

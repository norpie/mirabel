  ...
  return {
    ...
    tasks: [
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            type: 'detour-insert',
            status: 'completed',
            detourReason: 'Discovered expired tokens were not handled properly during testing',
            children: [
              {
                id: '3-3-1',
      ...
      },
      {
        ...
        type: 'detour-insert',
        status: 'completed',
        detourReason: 'Discovered connection pool exhaustion causing timeouts during OAuth testing',
        children: [
          {
            id: '4-1',
          ...
          },
          {
            ...
            children: [
              ...
              },
              {
                ...
                type: 'detour-around',
                status: 'in-progress',
                detourReason: 'Original complex permissions approach was too time-consuming, switching to MVP approach',
      ...
      },
      {
        ...
        type: 'detour-insert',
        status: 'pending',
        detourReason: 'Memory usage spiking during workspace creation testing - need to investigate before continuing',
        children: [
          {
            id: '7-1',

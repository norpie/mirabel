<script lang="ts">
	...
	import { User, Download, Trash2, AlertTriangle, CheckCircle, Shield, Calendar } from 'lucide-svelte';
				...
				<Card.Content class="space-y-4">
					<div class="space-y-2">
						<p class="text-sm text-muted-foreground">
							Export your account information, preferences, and associated data. 
							This includes your profile, workspaces, and session history.
						</p>
						<p class="text-sm text-muted-foreground">
			...
			<Card.Root class="border-red-200">
				...
				<Card.Content class="space-y-4">
					<Alert.Root variant="destructive">
						...
						<Alert.Description>
							Once you delete your account, there is no going back. This will permanently delete your profile, workspaces, and all associated data.
						</Alert.Description>
					</Alert.Root>

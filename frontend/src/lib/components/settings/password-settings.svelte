	...
	<div class="flex-1 space-y-6 p-6">
			...
			<Card.Root>
				...
				<Card.Content class="space-y-4">
					...
					<div class="flex items-center space-x-2">
						...
						/>
						<Label for="show-passwords" class="text-sm font-normal">
							Show passwords
						</Label>
					</div>
				</Card.Content>
			...
			<div class="flex justify-end space-x-2 pt-4">
				...
				<Button 
					...
					disabled={isLoading || validationErrors.length > 0 || !passwordForm.currentPassword || !passwordForm.newPassword || !passwordForm.confirmPassword}
				>

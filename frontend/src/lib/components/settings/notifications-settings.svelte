<script lang="ts">
	...
	import { Bell, Mail, MessageSquare, AlertTriangle, CheckCircle, Settings, Users } from 'lucide-svelte';
	...
	<div class="flex-1 space-y-6 p-6">
			...
			{#if !pushSupported}
				<Alert.Root variant="destructive">
					...
					<Alert.Description>
						Your browser doesn't support push notifications. Some notification features may not work.
					</Alert.Description>
				</Alert.Root>
			{/if}
				...
				<Card.Content class="space-y-4">
					<div class="space-y-4">
						<div class="flex items-center justify-between">
							...
							<Switch 
								bind:checked={notificationSettings.email.workspaceInvites}
							/>
						</div>
						...
						<div class="flex items-center justify-between">
							...
							<Switch 
								bind:checked={notificationSettings.email.sessionUpdates}
							/>
						</div>
						...
						<div class="flex items-center justify-between">
							...
							<Switch 
								bind:checked={notificationSettings.email.weeklyDigest}
							/>
						</div>
						...
						<div class="flex items-center justify-between">
							...
							<Switch 
								bind:checked={notificationSettings.email.marketing}
							/>
						</div>
					</div>
				</Card.Content>
			...
			<Card.Root>
				<Card.Header>
					...
					<Card.Description>
						Notifications shown while using the application
					</Card.Description>
				</Card.Header>
				<Card.Content class="space-y-4">
					<div class="space-y-4">
						<div class="flex items-center justify-between">
							...
							<Switch 
								bind:checked={notificationSettings.inApp.allNotifications}
							/>
						</div>
						...
						<div class="flex items-center justify-between">
							...
							<Switch 
								...
								disabled={!notificationSettings.inApp.allNotifications || !pushSupported}
							/>
						</div>
					</div>
				</Card.Content>
